...
class SipdPenetapanApbdResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'kode_bidang_urusan' => $this->whenLoaded('subKegiatan', fn () => $this->subKegiatan?->kegiatan?->program?->bidangUrusan?->kode_bidang_urusan),
            'nama_bidang_urusan' => $this->whenLoaded('subKegiatan', fn () => $this->subKegiatan?->kegiatan?->program?->bidangUrusan?->nama_bidang_urusan),
            'kode_urusan' => $this->whenLoaded('subKegiatan', fn () => $this->subKegiatan?->kegiatan?->program?->bidangUrusan?->urusan?->kode_urusan),
            'nama_urusan' => $this->whenLoaded('subKegiatan', fn () => $this->subKegiatan?->kegiatan?->program?->bidangUrusan?->urusan?->nama_urusan),
