...
class BaPembahasanExport implements FromArray, WithHeadings, WithStyles
{
    /**
    ...
    public function array(): array
    {
        ...
        foreach (($this->data['paket'] ?? []) as $i => $r) {
            $rows[] = [
                ...
                $this->rantai($r),
                $this->angka($r['pagu'] ?? 0),
                $this->angka($r['belanja_non_pengadaan'] ?? 0),
                $this->angka($r['belanja_pengadaan'] ?? 0),
    ...
    public function styles(Worksheet $sheet): array
    {
        ...
        foreach (['A' => 5, 'B' => 50, 'C' => 17, 'D' => 17, 'E' => 17, 'F' => 45] as $col => $w) {
